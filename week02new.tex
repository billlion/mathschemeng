...
\ifthenelse{\boolean{mynotes}}{
	...
	{\bf Solution}
$d_1=9$, $d_2=-9$. Swapping the first two rows corresponds changes the sign of teh determininant. Same as multiplying by a permutation matrix with a determinant of $-1$
...
\begin{array}{rrr}
 ...
 0 & 0 & 1
\end{array}
\right)=\bA^{-1},\qquad \bx = \bA^{-1}\bb =\left(
\begin{array}{r}
 \frac{1}{2} \\
 -\frac{1}{2} \\
 1
...
The same as we would get by back substituting
$z=1, y=-1/2,x=1/2$
